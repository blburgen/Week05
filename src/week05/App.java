 ...
 * b. The error method on the AsteriskLogger should print the String it receives inside a box of asterisks, with the 
 ...
 */
		...
		logger2.log("Hello");
		logger2.error("Hello");
		logger2.log("Why is there so much space.");
		logger2.error("Why is there so much space.");
